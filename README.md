...
lerobot-record --robot.type=bi_openarm_follower --robot.left_arm_config.port=can0 --robot.right_arm_config.port=can1 --robot.id=my_openarm_follower --robot.left_arm_config.cameras='{
